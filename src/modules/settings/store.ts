...
const KEY_EXECUTION_MODE = "executionMode";
const KEY_ACP_AGENT_ID = "acpAgentId";
...
export async function loadPreferences(): Promise<Preferences> {
  ...
  return {
    ...
    executionMode: get<ExecutionMode>(KEY_EXECUTION_MODE) ?? DEFAULT_PREFERENCES.executionMode,
    acpAgentId: get<string | null>(KEY_ACP_AGENT_ID) ?? DEFAULT_PREFERENCES.acpAgentId,
    defaultModelId:
...
export async function setExecutionMode(value: ExecutionMode): Promise<void> {
  await writePref(KEY_EXECUTION_MODE, value);
}

export async function setAcpAgentId(value: string | null): Promise<void> {
  await writePref(KEY_ACP_AGENT_ID, value);
}
