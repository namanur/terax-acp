...
import { ExecutionModeToggle } from "@/modules/ai/components/ExecutionModeToggle";
import { setExecutionMode } from "@/modules/settings/store";
...
export function ModelsSection() {
  ...
  const executionMode = usePreferencesStore((s) => s.executionMode);
  ...
  const handleModeChange = async (mode: "api_provider" | "acp_agent") => {
    await setExecutionMode(mode);
    await invoke("agent_set_execution_mode", { mode });
  };
  ...
  return (
    <div className="flex flex-col gap-7">
      <SectionHeader
        ...
        description="Choose how Terax executes prompts and configure model keys."
      />
